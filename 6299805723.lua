...
-- init
local NAME = "NXT"
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/StudNastty/Roblox/main/UI.lua"))()
...
local function sendWebhookMessage()
    ...
    local webhook = "https://discord.com/api/webhooks/963229017786445885/MCvsOG_3asKpkhufzUUGrrQelvlYYUnVusLH0wD1F0jKcGoGdPJVhVrBKFC7hE67Qqwn"
...
do
    ...
    do
        ...
        dsec1:addDropdown("Select Star to summon", eggData, function(value)
        ...
        dsec1:addDropdown("Select Star to auto max open", eggData, function(value)
            selectedEggMaxOpen = eggDisplayNameToNameLookUp[value]
        end)

        dSec2:addToggle("Auto fuse unlocked units",nil,function(value)
            autoFuse = value
        end)
